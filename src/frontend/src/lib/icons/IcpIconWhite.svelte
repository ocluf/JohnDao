<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 360 360" width="30">
	<style>
		.st4 {
			fill: url(#SVGID_00000072977826573920158100000003846691608688022923_);
		}
	</style>
	<g id="Token_Background">
		<circle cx="180" cy="180" r="179" fill="#fff" transform="rotate(-45.001 179.999 180.003)" />
		<path
			fill="#ddddde"
			d="M180 2c24 0 47.3 4.7 69.3 14 21.2 9 40.2 21.8 56.6 38.1 16.3 16.3 29.2 35.4 38.1 56.6 9.3 21.9 14 45.3 14 69.3s-4.7 47.3-14 69.3c-9 21.2-21.8 40.2-38.1 56.6-16.3 16.3-35.4 29.2-56.6 38.1-21.9 9.3-45.3 14-69.3 14s-47.3-4.7-69.3-14c-21.2-9-40.2-21.8-56.6-38.1C37.8 289.5 25 270.5 16 249.3 6.7 227.3 2 204 2 180s4.7-47.3 14-69.3c9-21.2 21.8-40.2 38.1-56.6C70.5 37.8 89.5 25 110.7 16 132.7 6.7 156 2 180 2m0-2C80.6 0 0 80.6 0 180s80.6 180 180 180 180-80.6 180-180S279.4 0 180 0z"
		/>
	</g>
	<g id="Infinity_Mark">
		<g id="Infinity_Mark_00000183241977157726863500000003439855629791590060_">
			...
			/>
			<linearGradient
				id="SVGID_00000107588343898637627670000013329189978103955082_"
				x1="75.257"
				x2="-1.356"
				y1="-296.506"
				y2="-375.841"
				gradientTransform="rotate(180 142.855 -81.632)"
				gradientUnits="userSpaceOnUse"
			>
			...
			<path
				fill="url(#SVGID_00000107588343898637627670000013329189978103955082_)"
